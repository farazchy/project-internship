...
# Group by searchDate, startingairport, and destinationairport to calculate average fare for each pair over time
price_trends = df_cleaned.groupBy("searchDate", "startingairport", "destinationairport") \
